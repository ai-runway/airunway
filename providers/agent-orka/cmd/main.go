...
import (
	...
	agentorka "github.com/ai-runway/airunway/providers/agent-orka"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "airunway-agent-orka-provider",
	})
	if err != nil {
	...
	reconciler := agentproviders.NewOrkaReconciler(mgr.GetClient(), mgr.GetAPIReader(), mgr.GetScheme())
	if err := reconciler.SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AgentOrkaProvider")
		os.Exit(1)
	}
	...
	versionReporter := agentproviders.NewFrameworkVersionReporter(
		mgr.GetClient(),
		agentorka.ProviderConfigName,
		agentorka.FrameworkName,
		airunwayv1alpha1.AgentProviderBackendCRD,
		agentorka.ProviderVersion,
	)
	...
	setupLog.Info("starting agent orka provider")
