...
// Package agentorka carries the reported build version for the agent-orka shim.
package agentorka

// FrameworkName is the AgentProviderConfig this shim serves.
const FrameworkName = "orka"

// ProviderConfigName names this shim for version reporting.
const ProviderConfigName = "agent-orka"
...
// "agent-orka-provider:v0.8.0"), published to AgentProviderConfig.status.version.
