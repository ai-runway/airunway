...
import (
	...
	agentcontainer "github.com/ai-runway/airunway/providers/agent-container"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "airunway-agent-container-provider",
	})
	if err != nil {
	...
	versionReporter := agentproviders.NewContainerVersionReporter(mgr.GetClient(), agentcontainer.ProviderConfigName, agentcontainer.ProviderVersion)
	...
	setupLog.Info("starting agent container provider")
